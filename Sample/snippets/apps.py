...
class SnippetsConfig(AppConfig):
    ...
    def ready(self):
        ...
        faces.append(faceSvm.processImg(Image.open(cwd+'/snippets/images/obama2.jpg','r'),1,False,False,(1024,1280, 3)))
        faces.append(faceSvm.processImg(Image.open(cwd+'/snippets/images/obama3.jpg','r'),1,False,False,(1024,1280, 3)))
